        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/products"
                className="inline-flex items-center justify-center px-6 py-3.5 bg-[#0D2740] text-white font-semibold rounded-xl transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 text-sm sm:text-base"
              >
                {ctaPrimary}
              </Link>
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center px-6 py-3.5 border-2 border-[#0D2740] text-[#0D2740] hover:bg-[#0D2740]/10 font-semibold rounded-xl transition-all duration-200 text-sm sm:text-base"
              >
                {ctaSecondary}
              </Link>
            </div>
          ...
          <div className="flex justify-center lg:justify-end animate-fade-up [animation-delay:200ms] opacity-0-init">
            <div className="w-full max-w-sm sm:max-w-md lg:max-w-full">
              <div className="bg-gray-100 rounded-2xl p-8 sm:p-12 flex flex-col items-center justify-center min-h-[220px] sm:min-h-[280px] border border-gray-200 shadow-sm">
